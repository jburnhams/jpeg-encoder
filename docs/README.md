...
- `dist/` - Compiled WASM files (generated by build)

## Building

To build the WASM files for the web:

```bash
npm run build:web
```

This will compile the Rust code to WebAssembly and generate bindings in the `dist` directory.
